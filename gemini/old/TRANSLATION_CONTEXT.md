# Task: Translate Bill-e UI to 9 Languages

**Your task**: Using the Spanish JSON as source, generate 9 complete translation files (en, pt, zh, hi, fr, ru, ja, de, id). Read the full context below to understand what each text means and where it appears in the UI.

**Output**: 9 separate JSON files, each clearly labeled (e.g., `=== en.json ===`).

---

# Bill-e Translation Context for Gemini
...
7. **Avoid unnecessary anglicisms** in non-English languages
