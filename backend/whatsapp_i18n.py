...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "session_expires": {
        "es": "La sesion expira en 1 hora",
        "en": "Session expires in 1 hour",
        "pt": "A sessao expira em 1 hora",
        "zh": "会话1小时后过期",
        "hi": "सेशन 1 घंटे में समाप्त होगा",
        "fr": "La session expire dans 1 heure",
        "ar": "تنتهي الجلسة خلال ساعة واحدة",
        "bn": "সেশন ১ ঘন্টায় শেষ হবে",
        "ru": "Сессия истекает через 1 час",
        "ja": "セッションは1時間で期限切れ",
        "de": "Sitzung laeuft in 1 Stunde ab",
        "id": "Sesi berakhir dalam 1 jam",
    },
