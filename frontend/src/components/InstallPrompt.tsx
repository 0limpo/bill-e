  ...
  if (deferredPrompt) {
    return (
      <button
        ...
        className="flex items-center gap-3 px-4 py-3 bg-secondary hover:bg-secondary/80 rounded-xl transition-colors w-full max-w-sm"
      >
  ...
  return (
    <div className="w-full max-w-sm">
      <button
        ...
        className="flex items-center gap-3 px-4 py-3 bg-secondary hover:bg-secondary/80 rounded-xl transition-colors w-full"
      >
